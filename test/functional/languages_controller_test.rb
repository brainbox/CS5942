...
class LanguagesControllerTest < ActionController::TestCase
  ...
  test "Test sucessfully get index with correct parameters" do
    get :index, {:first=>'2011-05-01', :last=>'2011-05-28', :interval=>'7'}
  ...
  test "Test sucessfully get index with bad start date" do
    get :index, {:first=>'', :last=>'2011-05-28', :interval=>'7'}
	assert_response :success
	contains_form
  end

  test "Test sucessfully get index with bad end date" do
    get :index, {:first=>'2011-05-01', :last=>'', :interval=>'7'}
	assert_response :success
	contains_form
  end

  test "Test sucessfully get index with start date after end date" do
    get :index, {:first=>'2011-05-28', :last=>'2011-05-01', :interval=>'7'}
	assert_response :success
	contains_form
	assert_equal 'End date must be after start date', flash[:notice]
  end

  test "Test sucessfully get index with start date equal end date" do
    get :index, {:first=>'2011-05-01', :last=>'2011-05-01', :interval=>'7'}
	assert_response :success
	contains_form
	assert_equal 'You can not select the same date', flash[:notice]
  end
